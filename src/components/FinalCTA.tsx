    ...
    <Section className="py-24 md:py-32 px-6">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <button
          ...
          className="inline-flex items-center justify-center bg-primary text-primary-foreground px-10 py-5 rounded-full text-lg font-semibold font-sans hover:brightness-110 transition-all shadow-xl shadow-primary/20"
        >
          Order Now
        </button>
